...
const char* ssid = "Galaxy A52ED5C";
const char* password = "3znt8364";
 
String myScript = "/macros/s/AKfycbyAlQ3I07oQpzGTy8puZ7QPBzfXL45nf82t54q4rl-0GskPbuh2DxFYd6n4pYoa0mrbgw/exec";    //Create your Google Apps Script and replace the "myScript" path.
...
void setup()
{
  ...
  if(psramFound()){
    ...
    onfig.grab_mode = CAMERA_GRAB_LATEST;
